/*!
 * vue-sfc-sandbox v0.1.3
 * (c) 2021 xiaoluoboding
 * @license MIT
 */
import { defineComponent, ref, reactive, computed, onMounted, onUnmounted, toRefs, openBlock, createBlock, createVNode, renderSlot, withModifiers, withScopeId, inject, watch, nextTick, pushScopeId, popScopeId, watchEffect, Fragment, createCommentVNode, toDisplayString, unref, Transition, toRaw, provide, withCtx, withDirectives, vShow, resolveComponent, Teleport } from 'vue';
...
async function compileFile({ filename, code, compiled }) {
    ...
    console.log(await hashId(filename))
...
const _hoisted_4$1 = { class: "editor-header__right" };
...
const _hoisted_6$1 = { class: "editor-container" };
popScopeId();
                        ...
                        createVNode("div", _hoisted_4$1, [
                            createVNode("div", {
                                ...
                                (openBlock(), createBlock("svg", {
                                    ...
                                    width: "16",
                                    height: "16",
                                    class: ["darkmode", { 'light': !unref(isDarkmode), 'dark': unref(isDarkmode) }]
                                }, [
                                    _hoisted_5$1
                                ], 2 /* CLASS */))
                            ])
...
var css_248z$5 = ".sfc-sandbox__editor[data-v-9f50ebd0]{height:100%}.sfc-sandbox__editor[data-v-9f50ebd0] .editor-header[data-v-9f50ebd0]{box-sizing:border-box;display:flex;height:40px;justify-content:space-between;align-items:center;background-color:var(--sfc-sandbox-bg-color);border-bottom:1px solid var(--sfc-sandbox-border-color)}.sfc-sandbox__editor[data-v-9f50ebd0] .editor-header[data-v-9f50ebd0] .editor-header__left[data-v-9f50ebd0]{padding:10px 12px;font-weight:500}.sfc-sandbox__editor[data-v-9f50ebd0] .editor-header[data-v-9f50ebd0] .editor-header__right[data-v-9f50ebd0] .actions[data-v-9f50ebd0]{cursor:pointer;display:flex;justify-content:center;align-items:center;height:40px;width:40px}.sfc-sandbox__editor[data-v-9f50ebd0] .editor-header[data-v-9f50ebd0] .editor-header__right[data-v-9f50ebd0] .actions[data-v-9f50ebd0][data-v-9f50ebd0]:hover{background-color:var(--sfc-sandbox-bg-color-66)}.sfc-sandbox__editor[data-v-9f50ebd0] .editor-header[data-v-9f50ebd0] .editor-header__right[data-v-9f50ebd0] .actions[data-v-9f50ebd0] .darkmode[data-v-9f50ebd0]{transition:all .3s ease-in}.sfc-sandbox__editor[data-v-9f50ebd0] .editor-header[data-v-9f50ebd0] .editor-header__right[data-v-9f50ebd0] .actions[data-v-9f50ebd0] .darkmode.light[data-v-9f50ebd0]{transform:rotate(540deg)}.sfc-sandbox__editor[data-v-9f50ebd0] .editor-container[data-v-9f50ebd0]{height:calc(100% - 40px);overflow:hidden;position:relative}";
...
var script$2 = defineComponent({
    ...
    setup(__props) {
        ...
        watch(() => runtimeError.value, (newVal) => {
            if (newVal) {
...
var css_248z = "body.overflow-hidden{overflow:hidden}";
