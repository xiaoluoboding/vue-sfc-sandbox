 ...
 * @license MIT
 */
import { defineComponent, ref, reactive, computed, onMounted, onUnmounted, toRefs, openBlock, createBlock, createVNode, renderSlot, withModifiers, withScopeId, pushScopeId, popScopeId, watch, Transition, toDisplayString, createCommentVNode, watchEffect, inject, Fragment, unref, toRaw, provide, withCtx } from 'vue';
    ...
    setup(__props) {
        ...
        return (_ctx, _cache) => {
            return (openBlock(), createBlock(Fragment, null, [
                ...
                createVNode(script$4, { err: runtimeError.value }, null, 8 /* PROPS */, ["err"]),
                (!runtimeError.value)
        ...
        return (_ctx, _cache) => {
            return (openBlock(), createBlock(script$6, {
                ...
                right: withCtx(() => [
                    ...
                    (esModules.value)
                        ? (openBlock(), createBlock(script$2, { key: 0 }))
                        : (openBlock(), createBlock(script$1, { key: 1 }))
                ]),
                _: 1 /* STABLE */
            }, 8 /* PROPS */, ["style"]));
        };
