...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue'), require('@codemirror/basic-setup'), require('@codemirror/lang-html'), require('@vue/compiler-sfc'), require('@vue/compiler-sfc/dist/compiler-sfc.esm-browser')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue', '@codemirror/basic-setup', '@codemirror/lang-html', '@vue/compiler-sfc', '@vue/compiler-sfc/dist/compiler-sfc.esm-browser'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['sfc-sandbox'] = {}, global.Vue, global.CodeMirror, global.CodeMirrorLangHtml, global.CompilerSfc, global.CompilerSfcEsm));
}(this, (function (exports, vue, basicSetup, langHtml, compilerSfc, defaultCompiler) { 'use strict';
  ...
  const render$2 = /*#__PURE__*/_withId$2((_ctx, _cache, $props, $setup, $data, $options) => {
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      onMouseleave: _cache[4] || (_cache[4] = (...args) => (_ctx.dragEnd && _ctx.dragEnd(...args)))
    }, [
      vue.createVNode("div", {
  ...
  var script$5 = vue.defineComponent({
    ...
    setup (props, { emit }) {
      ...
      vue.onMounted(() => {
        const onUpdate = () =>
          basicSetup.EditorView.updateListener.of(({ state }) => {
        ...
        store.view = new basicSetup.EditorView({
          state: editorState,
          parent: store.el
        });
      });
  ...
  const generateHashId = (seed) => undefined('sha256').update(seed).digest('base64').slice(0, 16);
  ...
  const IMPORT_MAP_CODE = `
{
  ...
  const _hoisted_1$1 = { class: "sfc-sandbox__editor" };
  vue.popScopeId();
  ...
  var css_248z$3 = ".sfc-sandbox__editor[data-v-9f50ebd0]{height:100%;overflow:hidden;position:relative}";
  styleInject(css_248z$3);

  script$3.__scopeId = "data-v-9f50ebd0";
  script$3.__file = "packages/sandbox/SandboxEditor.vue";
  ...
  var script$2 = vue.defineComponent({
      ...
      setup(__props) {
          ...
          const uuid = vue.ref(generateHashId(new Date().toString()));
          let sandbox;
          let proxy;
          ...
          return (_ctx, _cache) => {
              return (vue.openBlock(), vue.createBlock(vue.Fragment, null, [
                  vue.createVNode("div", {
                      class: "sfc-sandbox__preview",
                      ref: container
                  }, null, 512 /* NEED_PATCH */),
                  vue.createVNode(script$4, { err: runtimeError.value }, null, 8 /* PROPS */, ["err"]),
                  (!runtimeError.value)
  ...
  var css_248z$2 = ".sfc-sandbox__preview,iframe{width:100%;height:100%;border:none;background-color:#fff}";
  styleInject(css_248z$2);

  script$2.__file = "packages/sandbox/SandboxPreview.vue";

  const _hoisted_1 = { class: "sfc-sandbox__loading-mask" };
  const _hoisted_2 = /*#__PURE__*/vue.createVNode("div", { class: "loading-spinner" }, [
          ...
          return (_ctx, _cache) => {
              return (vue.openBlock(), vue.createBlock(script$6, {
                  ...
                  right: vue.withCtx(() => [
                      ...
                      (esModules.value)
                          ? (vue.openBlock(), vue.createBlock(script$2, { key: 0 }))
                          : (vue.openBlock(), vue.createBlock(script$1, { key: 1 }))
                  ]),
                  _: 1 /* STABLE */
              }, 8 /* PROPS */, ["style"]));
          };
