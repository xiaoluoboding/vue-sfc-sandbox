...
(function (global, factory) {
  ...
  var script$5 = vue.defineComponent({
    ...
    setup (props, { emit }) {
      ...
      vue.onMounted(() => {
        const onUpdate = () =>
          basicSetup.EditorView.updateListener.of(debounce(({ state }) => {
  ...
  const IMPORT_MAP_CODE = `
{
              ...
              return (vue.openBlock(), vue.createBlock(vue.Fragment, null, [
                  ...
                  vue.createVNode("div", _hoisted_1$2, [
                      vue.createVNode("header", _hoisted_2$2, [
                          vue.createVNode("div", _hoisted_3, vue.toDisplayString(__props.sfcFilename), 1 /* TEXT */)
                      ]),
                      vue.createVNode("main", _hoisted_4, [
  ...
  const _hoisted_2$1 = /*#__PURE__*/ vue.createVNode("header", { class: "preview-header" }, [
      /*#__PURE__*/ vue.createVNode("div", { class: "preview-header__left" }, " Preview ")
  ], -1 /* HOISTED */);
  var script$2 = vue.defineComponent({
      ...
      setup(__props) {
          ...
          const uuid = vue.ref(btoa(Date.now().toString()));
          let sandbox;
          let proxy;
          ...
          return (_ctx, _cache) => {
              return (vue.openBlock(), vue.createBlock(script$6, {
                  ...
                  right: vue.withCtx(() => [
                      ...
                      vue.withDirectives(vue.createVNode(script$2, { "sfc-filename": __props.sfcFilename }, null, 8 /* PROPS */, ["sfc-filename"]), [
                          [vue.vShow, esModules.value]
                      ]),
                      (isLoadingPreview.value)
                          ? (vue.openBlock(), vue.createBlock(script$1, { key: 0 }))
                          : vue.createCommentVNode("v-if", true)
                  ]),
                  _: 1 /* STABLE */
              }, 8 /* PROPS */, ["style"]));
