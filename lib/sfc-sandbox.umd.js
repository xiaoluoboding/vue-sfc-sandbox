...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue'), require('@codemirror/basic-setup'), require('@codemirror/view'), require('@codemirror/commands'), require('@codemirror/lang-html'), require('@vue/compiler-sfc'), require('@vue/compiler-sfc/dist/compiler-sfc.esm-browser')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue', '@codemirror/basic-setup', '@codemirror/view', '@codemirror/commands', '@codemirror/lang-html', '@vue/compiler-sfc', '@vue/compiler-sfc/dist/compiler-sfc.esm-browser'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['sfc-sandbox'] = {}, global.Vue, global.CodeMirror, global.CodeMirrorViews, global.CodeMirrorCommands, global.CodeMirrorLangHtml, global.CompilerSfc, global.CompilerSfcEsm));
}(this, (function (exports, vue, basicSetup, view, commands, langHtml, compilerSfc, defaultCompiler) { 'use strict';
  ...
  var script$7 = vue.defineComponent({
      ...
      setup(props, { emit }) {
          ...
          const splitPaneStyle = vue.computed(() => {
              return {
                  'flex-direction': state.isHorizontal ? 'row' : 'column'
              };
          });
          const leftStyle = vue.computed(() => {
          ...
          const draggerStyle = vue.computed(() => {
              return state.isHorizontal
  ...
  const _withId$2 = /*#__PURE__*/vue.withScopeId("data-v-9241e4e6");
  ...
  const render$3 = /*#__PURE__*/_withId$2((_ctx, _cache, $props, $setup, $data, $options) => {
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      vue.createVNode("div", {
        ...
        onMousedown: _cache[1] || (_cache[1] = vue.withModifiers((...args) => (_ctx.dragStart && _ctx.dragStart(...args)), ["prevent"]))
  ...
  var script$6 = vue.defineComponent({
    ...
    setup (props, { emit }) {
      ...
      vue.onMounted(() => {
        const onUpdate = () => {
          return view.EditorView.updateListener.of(debounce(({ state }) => {
        ...
        const tabBinding = () => {
          return [
            view.keymap.of([...commands.defaultKeymap, commands.defaultTabBinding]),
            basicSetup.EditorState.tabSize.of(2)
          ]
        };

        const editorState = basicSetup.EditorState.create({
          doc: store.doc,
          extensions: [
        ...
        store.view = new view.EditorView({
          state: editorState,
          parent: store.el
        });
      });
  ...
  const _withId$1 = /*#__PURE__*/vue.withScopeId("data-v-0b029634");

  vue.pushScopeId("data-v-0b029634");
  const _hoisted_1$4 = {
  ...
  const IMPORT_MAP_CODE = `
{
  ...
  vue.pushScopeId("data-v-9f50ebd0");
  ...
  var script$5 = vue.defineComponent({
      ...
      setup(__props) {
          const props = __props;
          const isLoading = vue.inject(IS_LOADING_PREVIEW);
          const esModules = vue.inject(ES_MODULES);
          const sharedCode = vue.inject(SHARED_CODE);
          ...
          const activeCode = vue.ref(props.sfcCode);
          const activeMode = vue.computed(() => (props.sfcFilename.endsWith('.vue') ? 'htmlmixed' : 'javascript'));
          vue.watch(() => props.sfcCode, (newVal) => (activeCode.value = newVal));
          vue.watch(() => activeCode.value, (newVal) => onChange(newVal), {
              immediate: true
          });
          vue.onMounted(() => {
              if (props.sfcCode !== '') {
          ...
          return (_ctx, _cache) => {
              return (vue.openBlock(), vue.createBlock(vue.Fragment, null, [
                  vue.createCommentVNode(" <FileSelector/> "),
                  vue.createVNode("div", _hoisted_1$3, [
                      vue.createVNode("header", _hoisted_2$2, [
                          vue.createVNode("div", _hoisted_3$1, vue.toDisplayString(__props.sfcFilename), 1 /* TEXT */)
                      ]),
                      vue.createVNode("main", _hoisted_4$1, [
                          vue.createVNode(script$6, {
                              modelValue: activeCode.value,
                              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => (activeCode.value = $event)),
                              mode: vue.unref(activeMode)
                          }, null, 8 /* PROPS */, ["modelValue", "mode"]),
                          vue.createCommentVNode(" <Message :err=\"fileErrors\" /> ")
                      ])
                  ])
  ...
  const _withId = /*#__PURE__*/ vue.withScopeId("data-v-7de6be8b");
  var script$4 = vue.defineComponent({
      ...
      setup(__props) {
          ...
          vue.watch(() => [props.err, props.warn], () => {
              ...
              return (vue.openBlock(), vue.createBlock(vue.Transition, { name: "fade" }, {
                  default: _withId(() => [
                      (!dismissed.value && (__props.err || __props.warn))
                          ? (vue.openBlock(), vue.createBlock("pre", {
                              key: 0,
                              class: ["msg", __props.err ? 'err' : 'warn'],
                              onClick: _cache[1] || (_cache[1] = ($event) => (dismissed.value = true))
                          }, "      " + vue.toDisplayString(formatMessage(__props.err || __props.warn)) + "\n    ", 3 /* TEXT, CLASS */))
  ...
  const _hoisted_2$1 = /*#__PURE__*/vue.createVNode("div", { class: "loading-spinner" }, [
  ...
  const _hoisted_3 = /*#__PURE__*/ vue.createVNode("div", { class: "preview-header__left" }, " Preview ", -1 /* HOISTED */);
  ...
  const _hoisted_8 = /*#__PURE__*/ vue.createVNode("path", {
  ...
  var script$2 = vue.defineComponent({
      ...
      setup(__props) {
          ...
          const importMaps = vue.inject(IMPORT_MAPS_KEY);
          const externals = vue.inject(EXTERNALS_KEY);
          const isLoadingPreview = vue.inject(IS_LOADING_PREVIEW);
          const isResized = vue.inject(IS_RESIZED);
          const isFullpage = vue.inject(IS_FULLPAGE);
          const esModules = vue.inject(ES_MODULES);
          const container = vue.ref();
          const runtimeError = vue.ref();
          const runtimeWarning = vue.ref();
          const fileErrors = vue.computed(() => store.files[props.sfcFilename]?.compiled?.errors[0]);
          vue.watch(() => isResized.value, (newVal) => {
              if (newVal) {
                  recreateSandbox();
              }
          });
          ...
          function createSandbox() {
              ...
              sandbox.addEventListener('load', () => {
                  proxy.handle_links();
                  stopUpdateWatcher = vue.watchEffect(updatePreview);
              });
          }
          async function updatePreview() {
              ...
              try {
                  ...
                  // const modules = await compileModules(props.sfcFilename)
                  const modules = vue.toRaw(esModules.value);
          ...
          return (_ctx, _cache) => {
              return (vue.openBlock(), vue.createBlock("div", _hoisted_1$1, [
                  vue.createVNode("header", _hoisted_2, [
                      _hoisted_3,
                      vue.createVNode("div", _hoisted_4, [
                          vue.createCommentVNode(" fullpage icon "),
                          vue.createVNode("a", {
                              href: "javascript:;",
                              onClick: toggleFullpage
                          }, [
                              (vue.unref(isFullpage))
                                  ? (vue.openBlock(), vue.createBlock("svg", _hoisted_5, [
                                      _hoisted_6
                                  ]))
                                  : (vue.openBlock(), vue.createBlock("svg", _hoisted_7, [
                                      _hoisted_8
                                  ]))
                          ])
                      ])
                  ...
                  vue.createVNode("main", {
                      ...
                      (vue.unref(isLoadingPreview))
                          ? (vue.openBlock(), vue.createBlock(script$3, { key: 0 }))
                          : vue.createCommentVNode("v-if", true)
                  ], 512 /* NEED_PATCH */),
                  vue.createVNode("footer", null, [
                      vue.createVNode(script$4, {
                          err: runtimeError.value || vue.unref(fileErrors)
                      }, null, 8 /* PROPS */, ["err"]),
                      (!runtimeError.value)
  ...
  var script$1 = vue.defineComponent({
      ...
      setup(__props) {
          const props = __props;
          const isLoadingPreview = vue.ref(false);
          const isResized = vue.ref(false);
          // const isFullpage = ref(false)
          const esModules = vue.ref([]);
          vue.provide(IMPORT_MAPS_KEY, props.importMaps);
          vue.provide(EXTERNALS_KEY, props.externals);
          vue.provide(IS_LOADING_PREVIEW, isLoadingPreview);
          vue.provide(IS_RESIZED, isResized);
          vue.provide(ES_MODULES, esModules);
          const isFullpage = vue.inject(IS_FULLPAGE);
          vue.watch(isLoadingPreview, (newVal, oldVal) => {
              if (oldVal) {
                  const styles = [
                      'color: white',
                      'background: #42b983',
          ...
          const sandboxStyles = vue.computed(() => {
              return {
          ...
          const handleResized = (panes) => {
              ...
              vue.nextTick(() => (isResized.value = false));
          };
          return (_ctx, _cache) => {
              return (vue.openBlock(), vue.createBlock(script$7, {
                  class: ["sandbox", { 'is-fullpage': vue.unref(isFullpage) && __props.isTeleport }],
                  style: vue.unref(sandboxStyles),
                  ...
                  right: vue.withCtx(() => [
                      vue.createCommentVNode(" <Suspense>\n        <template #default v-if=\"esModules\">\n          <sandbox-preview />\n        </template>\n        <template #fallback>\n          <loading-mask v-if=\"isLoadingPreview\" />\n        </template>\n      </Suspense> "),
                      vue.withDirectives(vue.createVNode(script$2, {
                          "sfc-filename": __props.sfcFilename,
                          "sfc-code": __props.sfcCode
                      }, null, 8 /* PROPS */, ["sfc-filename", "sfc-code"]), [
                          [vue.vShow, esModules.value]
                      ])
                  ]),
                  _: 1 /* STABLE */
              }, 8 /* PROPS */, ["class", "style"]));
  ...
  var script = vue.defineComponent({
      ...
      setup(props, { emit }) {
          const isFullpage = vue.ref(false);
          const localProps = vue.reactive(vue.toRefs(props));
          const sharedCode = vue.ref(props.sfcCode);
          vue.provide(IS_FULLPAGE, isFullpage);
          vue.provide(SHARED_CODE, sharedCode);
          return {
              isFullpage,
              sharedCode,
              ...vue.toRefs(localProps)
          };
      }
  });
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_Sandbox = vue.resolveComponent("Sandbox");

    return (vue.openBlock(), vue.createBlock("div", _hoisted_1, [
      (!_ctx.isFullpage)
        ? (vue.openBlock(), vue.createBlock(_component_Sandbox, {
            key: 0,
            height: _ctx.height,
  ...
  exports.SfcSandbox = script;
  exports.SplitPane = script$7;
